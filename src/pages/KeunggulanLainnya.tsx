import KeunggulanImg from '../img/lainnya2.avif';
import { motion } from 'framer-motion';

const KeunggulanLainnya = () => {
  return (
    <section
      id="hero"
    ...
    >
      ...
      >
        ...
        {/* List */}
        <motion.ul
          className="text-white text-center md:text-left space-y-3 md:space-y-4 text-sm md:text-lg lg:text-xl"
          initial={{ opacity: 0 }}
          ...
          viewport={{ once: true }}
        >
          {['Kami menyediakan saran perjalanan terbaik, dokumen perjalanan bisnis, asuransi, dan pengantaran dalam keadaan mendesak.'].map((item, index) => (
...
export default KeunggulanLainnya;
