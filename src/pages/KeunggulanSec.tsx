...
const KeunggulanSec = () => {
  return (
    <section
      className="relative w-full min-h-[600px] bg-cover bg-center flex items-center justify-center md:justify-end px-6 md:px-16 lg:px-32"
      style={{
    ...
    >
      ...
      >
        ...
        {/* List */}
        <motion.ul
          className="text-white text-left list-disc list-inside space-y-3 md:space-y-4 text-base md:text-lg lg:text-xl"
          initial={{ opacity: 0 }}
